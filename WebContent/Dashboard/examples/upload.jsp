         ...
         <div class="main-panel">
             ...
             <div class="content" style="height:100%;">
                 <div class="container-fluid">
                      <div class="row">
                        <div class="col-md-12">
                                <form class="bx upload"  action="../../upload" method="POST" enctype="multipart/form-data">
                                        <h1>Upload File</h1>
                                        
                                        <select name=yos class="mdb-select md-form">
                                            <option value="" disabled selected>Select Year of Study</option>
                                            <option value="SE">SE</option>
                                            <option value="TE">TE</option>
                                            <option value="BE">BE</option>
                                          </select>
                                        <select name=yoe class="mdb-select md-form">
                                            <option value="" disabled selected>Select Year of Exam</option>
                                            <option value="2">
                                                <script>
                                        ...
                                        <input class="bx__textbox" type="file" name="file">
                                        <input class="bx__button" type="submit" value="Upload">
                                </form>
                        </div>
                     </div>
                 </div>
